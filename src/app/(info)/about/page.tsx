    ...
    <section className="py-16 px-8">
      <div className="container mx-auto flex flex-col items-center text-center">
        ...
        <p className="text-lg leading-relaxed max-w-3xl mb-8">
          ...
          allowing users to challenge their friends and test their knowledge in
          real-time quizzes. Whether you&apos;re looking to improve your
          knowledge or just have fun with friends, ThinkFast helps you think on
          your feet—faster than ever! 🚀
        </p>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 mt-8">
          ...
          <div className="bg-white text-gray-800 p-6 rounded-lg shadow-lg max-w-sm hover:scale-105 transition-transform">
            ...
            <p className="text-base">
              ...
              social interaction, ThinkFast aims to revolutionize how the world
              learns!
            </p>
          </div>
        </div>
